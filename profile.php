...
<head>
    ...
    <title>Create or Update your User Profle</title>
</head>
<body>
    ...
    <form action="/update_profile.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div>
            ...
            <input type="date" id="dateOfBirth" name="dateOfBirth" 
                   value="<?php echo getUserData('date_of_birth'); ?>" required>
        ...
        <div>
            ...
            <input type="text" id="securityAnswer1" name="securityAnswer1" 
                   placeholder="Where was your first vacation spot?" 
                   value="">
        </div>
        <br>
        ...
        <div>
            ...
            <input type="text" id="securityAnswer2" name="securityAnswer2" 
                   placeholder="When did you lose your first tooth?" 
                   value="">
        </div>
        <br>
        ...
        <div>
            <input type="submit" value="Save Changes" style="background-color: #007bff; color: white; padding: 12px 24px; border: none; border-radius: 4px; font-size: 16px; cursor: pointer;">
            <br/>
            <br/>
