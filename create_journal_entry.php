...
<link rel="stylesheet" href="/styling/create_journal_entry.css">
<div class="container"
    ...
    <div class="account-info-box">
        <h2>Account: <?php echo $account['account_number']; ?> -
            <?php echo $account['name']; ?>
        </h2>
        <p><strong>Category:</strong> <?php echo $account['category']; ?> |
            <strong>Normal Side:</strong> <?php echo $account['normal_side']; ?> |
            <strong>Balance:</strong> $<?php echo number_format((float) $account['balance'], 2); ?>
        </p>
    </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" required
                        placeholder="Enter a description for this journal entry..."></textarea>
                </div>

                <div class="form-group">
                    <label for="reference">Reference Number</label>
                    <input type="text" id="reference" name="reference"
                        placeholder="Optional reference number (e.g., INV-001, PO-123)">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-description">
                        Check this box if this is an adjusting entry (e.g., accruals, deferrals, depreciation,
                        corrections)
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="file-upload-area">
                    <input type="file" id="sourceDocuments" name="source_documents[]"
                        accept=".pdf,.doc,.docx,.xls,.xlsx,.csv,.jpg,.jpeg,.png" multiple style="display: none;"
...
<script>
    ...
    //this function adds additional entry lines if additional details need to be added to this journal entry
    ...
    //delete the most recent entry line added 
    ...
    //calculates total debit/credit info
    ...
    //function to clear entirety of form 
