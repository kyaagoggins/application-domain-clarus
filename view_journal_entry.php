...
<div class="container"
    ...
    <div class="action-buttons">
        <div class="route-buttons">
            <button onclick="window.history.back()" class="btn btn-back" style="width:20%; margin-right:1%">
                ⬅️ Back
            </button>
            <a href="view_journal_entries.php" class="btn btn-back" style="width:20%; margin-top:1%; margin-right:20%">
                📋 All Entries
            </a>
            <a href="account_ledger.php?account_number=<?php echo urlencode($entry['account_id']); ?>"
                class="btn btn-back" style="width:20%; margin-top:1%;">
                📒 View Ledger
            </a>
            <button onclick="window.print()" class="btn btn-print" style="width:20%; margin-left:1%;">
                🖨️ Print
            </button>
        </div>
        ...
        <div class="info-card">
            ...
            <div class="info-value">
                <a href="view_account.php?account_number=<?php echo urlencode($entry['account_id']); ?>"
                    class="account-link">
                    <?php echo htmlspecialchars($entry['account_id']); ?> -
            ...
            <div class="documents-grid">
                <?php foreach ($sourceDocuments as $doc):
                    ...
                    <div class="document-card">
                        ...
                        <a href="../uploads/journal_documents/<?php echo urlencode($doc); ?>" target="_blank"
                            class="document-link">
                            📥 Download
                        </a>
                    </div>
