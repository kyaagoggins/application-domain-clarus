    ...
    <form action="push_user_edits.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div>
            ...
            <select name="accessLevel" id="accessLevel" required>
                ...
                <option value="3" <?php echo $user_data['access_level'] == '3' ? 'selected' : ''; ?>>Administrator
                </option>
        ...
        <div>
            ...
            <div id="passwordRequirements" style="color: #666; font-size: 11px; margin-top: 3px;">
                Password must be at least 8 characters, start with a letter, and contain a letter, number, and special
                character.
            </div>
        </div>
        <br>
        ...
        <div>
            ...
            <input type="date" id="dateOfBirth" name="dateOfBirth" value="<?php echo $user_data['date_of_birth']; ?>"
                required>
        </div>
        <br>
        <div>
