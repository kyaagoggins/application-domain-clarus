...
<div class="container"
    ...
    <form action="create_account.php" method="POST" onsubmit="return validateForm()">
        <div class="form-container">
            ...
            <div class="form-column">
                <div class="form-group">
                    <label for="accountNumber">Account Number <span class="required">*</span>
                        <a data-bs-toggle="tooltip"
                            title="Enter a unique numeric identifier for this account. Use only numbers (no letters, spaces, or special characters). Examples: 1000, 2000, 3000. This will be used to identify the account in transactions."><i
                    ...
                    <div class="help-text">Enter a unique account number (numbers only, no spaces or decimals)
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="accountName">Account Name <span class="required">*</span>
                        <a data-bs-toggle="tooltip"
                            title="Enter a descriptive name for this account. Use clear, professional naming conventions. Examples: 'Cash', 'Accounts Receivable', 'OfficeSupplies', 'Sales Revenue'. This name will appear on financial statements."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                    <input type="text" id="accountName" name="name" required maxlength="100"
                ...
                <div class="form-group">
                    <label for="description">Description
                        <a data-bs-toggle="tooltip"
                            title="Optional detailed description providing additional context about this account. Include specific details about what transactions should be recorded here, account purpose, or any special instructions for users."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                ...
                <div class="form-group">
                    <label for="normalSide">Normal Side Description<span class="required">*</span>
                        <a data-bs-toggle="tooltip"
                            title="Select whether this account normally has a debit or credit balance. Assets and Expenses normally have debit balances. Liabilities, Equity, and Revenue normally have credit balances. This determines how increases and decreases are recorded."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                    ...
                    <div class="help-text">Assets/Expenses = Debit, Liabilities/Equity/Revenue = Credit
                    </div>
                </div>

                <div class="form-group">
                    <label for="category">Category Description<span class="required">*</span>
                        <a data-bs-toggle="tooltip"
                            title="Select the main classification for this account. Assets: things owned (cash, equipment). Liabilities: debts owed (loans, payables). Equity: ownership interest (capital, retained earnings). Revenue: income earned. Expenses: costs incurred."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                ...
                <div class="form-group">
                    <label for="subcategory">Subcategory Description
                        <a data-bs-toggle="tooltip"
                            title="Select a more specific classification within the chosen category. This helps organize accounts for reporting and analysis. Examples: Current Assets, Fixed Assets, Operating Expenses, etc."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                ...
                <div class="form-group">
                    <label for="statement">Financial Statement Description<span class="required">*</span>
                        <a data-bs-toggle="tooltip"
                            title="Select which financial statement this account will appear on. Balance Sheet: Assets, Liabilities, Equity. Income Statement: Revenue, Expenses. Statement of Cash Flows: Cash-related accounts. Statement of Equity: Equity accounts."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
            ...
            <div class="form-column">
                <div class="form-group">
                    <label for="initialBalance">Initial Balance Description
                        <a data-bs-toggle="tooltip"
                            title="Enter the starting balance for this account when it's created. This represents the account's value at the time of setup. Leave as 0.00 if this is a new account with no initial balance."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                ...
                <div class="form-group">
                    <label for="debitAmount">Debit Amount Description
                        <a data-bs-toggle="tooltip"
                            title="Enter any initial debit amount for this account. Debits increase asset and expense accounts, and decrease liability, equity, and revenue accounts. Leave as 0.00 if no initial debit is needed."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                    <input type="text" id="debitAmount" name="debit" value="0.00" oninput="formatCurrency(this)"
                        onchange="updateBalance()">
                    <div class="help-text">Initial debit amount (if any)</div>
                </div>

                <div class="form-group">
                    <label for="creditAmount">Credit Amount Description
                        <a data-bs-toggle="tooltip"
                            title="Enter any initial credit amount for this account. Credits increase liability, equity, and revenue accounts, and decrease asset and expense accounts. Leave as 0.00 if no initial credit is needed."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                    <input type="text" id="creditAmount" name="credit" value="0.00" oninput="formatCurrency(this)"
                        onchange="updateBalance()">
                    <div class="help-text">Initial credit amount (if any)</div>
                </div>

                <div class="form-group">
                    <label for="balance">Current Balance Description
                        <a data-bs-toggle="tooltip"
                            title="This field is automatically calculated based on the initial balance, debit amount, and credit amount you entered. The calculation considers the normal side of the account to determine the final balance."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                    <input type="text" id="balance" name="balance" value="0.00" readonly disabled>
                    <div class="help-text">Calculated automatically based on normal side and amounts</div>
                </div>

                <div class="form-group">
                    <label for="orderType">Order Type Description
                        <a data-bs-toggle="tooltip"
                            title="Select how this account should be ordered on financial statements. This helps organize accounts in a logical sequence for reporting. Examples: Current Assets appear before Non-Current Assets on the Balance Sheet."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
                ...
                <div class="form-group">
                    <label for="comment">Comments Description
                        <a data-bs-toggle="tooltip"
                            title="Enter any additional notes, comments, or special instructions about this account. This can include setup notes, usage guidelines, or any other relevant information that will help users understand how to use this account properly."><i
                                class="fa-solid fa-circle-info"></i>
                        </a>
                    </label>
